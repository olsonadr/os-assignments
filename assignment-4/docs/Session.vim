...
badd +6 compileall
badd +1 src/keygen.c
badd +1 src/otp_dec.c
badd +1 src/otp_dec_d.c
badd +1 src/otp_enc.c
badd +0 src/otp_enc_d.c
args README.md compileall src/keygen.c src/otp_dec.c src/otp_dec_d.c src/otp_enc.c src/otp_enc_d.c
edit README.md
